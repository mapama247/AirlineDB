/*************************************************************************************
 Flight addition interfaces test script.
 This is a test script that tests that the interface of the back-end works correctly.
 It simply tests that the interface exists for filling the db with flight information,
 without acutally checking that they do what they are supposed to.
*************************************************************************************/
...
/******************************************************************************************
 Reservation interfaces test script.
 This is a test script that tests that the interface of the back-end works correctly.
 More specifically it tests that the interfaces handling the reservation
 procedures works correctly and gives the correct output.
 The test-cases are:
...
/******************************************************************************************
  Final test to test for check against overbooking, should print the message
